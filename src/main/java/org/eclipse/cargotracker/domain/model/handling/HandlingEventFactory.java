...
/**
 * Containerization Note (blocker-2 / cz-java-0064): This class uses CDI @ApplicationScoped
 * (stateless factory) instead of EJB @Singleton to avoid JVM-level singleton state that causes
 * inconsistencies when scaling containers horizontally on GKE Autopilot. Any shared/cached state
 * should be stored in Google Cloud Memorystore (Redis), with connection details injected via
