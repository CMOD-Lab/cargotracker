...
// Singleton-held state (SSE broadcaster) is externalized to Amazon ElastiCache (Redis) via environment variables.
// Redis connection: REDIS_HOST=${REDIS_HOST}, REDIS_PORT=${REDIS_PORT} (injected via Kubernetes ConfigMap/Secret).
