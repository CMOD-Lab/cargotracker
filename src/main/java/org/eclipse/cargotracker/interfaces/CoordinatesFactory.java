 ...
 *
 * <p>cz-java-0070: Local in-process cache externalized to Azure Cache for Redis on AKS.
 ...
 * The static COORDINATES_MAP local cache should be replaced with Azure Cache for Redis
...
public class CoordinatesFactory {
  ...
  // Replace the static COORDINATES_MAP with Redis-backed cache for horizontal scaling.
  private static final String REDIS_CONNECTION_STRING =
      System.getenv().getOrDefault("REDIS_CONNECTION_STRING", "");

  // cz-java-0070: This static local cache (COORDINATES_MAP) should be replaced with
