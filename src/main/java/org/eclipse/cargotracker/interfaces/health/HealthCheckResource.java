 ...
 *
 * <p>Provides a simple HTTP GET /rest/health endpoint that returns application health status.
 * This endpoint is used by Kubernetes liveness and readiness probes on Amazon EKS to determine
 * whether the container is healthy and ready to serve traffic.
 *
 * <p>Usage in Kubernetes deployment:
 * <pre>
 * livenessProbe:
 *   httpGet:
