...
public class HandlingEventTest {
  ...
  private final RouteSpecification routeSpecification =
      new RouteSpecification(SampleLocations.HONGKONG, SampleLocations.NEWYORK, LocalDate.now(ZoneOffset.UTC));
  ...
  public void testNewWithCarrierMovement() {
    ...
    for (HandlingEvent.Type type :
      ...
      try {
        new HandlingEvent(
            cargo, LocalDateTime.now(ZoneOffset.UTC), LocalDateTime.now(ZoneOffset.UTC), type, SampleLocations.HONGKONG, null);
